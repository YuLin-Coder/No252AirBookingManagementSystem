...
<div id="login">
        ...
        <div class="main">
            <form class="formname" action="<%=basePath%>mimaUser" name="form1" method="post" onSubmit="return check()">
            <ul>
            	<input id="userId" name="userId" type="hidden" value="<%=userId%>"/>
                <li>原密码： <input class="wa" type="password" name="userPassword" id="userPassword"/></li>
                <li>新密码： <input class="wa" type="password" name="userPassword1" id="userPassword1"/></li>
                <li>再输入： <input class="wa" type="password" name="userPassword2" id="userPassword2"/></li>
