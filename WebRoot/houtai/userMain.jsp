...
<div class="header bg-main">
  ...
  <div class="head-l">
  	<a class="button button-little bg-green"><span class="icon-home"></span><%=userName %></a> &nbsp;&nbsp;
...
<div class="leftnav">
  ...
  <ul style="display:block">
    <li><a href="<%=basePath%>user/user.jsp" target="right"><span class="icon-caret-right"></span>个人信息</a></li>
    <li><a href="<%=basePath%>user/usermima.jsp" target="right"><span class="icon-caret-right"></span>修改口令</a></li>
  </ul>
  ...
  <ul>
    ...
    <li><a href="<%=basePath%>user/<%=jcdaohangslist.get(i).get(j).getJcdaohangNeirong() %>" target="right"><span class="icon-caret-right"></span><%=jcdaohangslist.get(i).get(j).getJcdaohangName() %></a></li>
    <%} %>
  </ul>
  <%} %>
</div>
