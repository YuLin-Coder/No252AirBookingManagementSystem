...
<%
	...
	System.out.println("yonghuPassword:"+yonghuPassword);
%>
...
var url;
	function searchYonghu(){
		$('#dg').datagrid('load',{
			...
			yonghuType1:$('#s_yonghuType1').combobox("getValue"),
			yonghuType2:$('#s_yonghuType2').combobox("getValue"),
			yhroleId:$('#s_yhroleId').combobox("getValue"),
			yonghuSex:$('#s_yonghuSex').combobox("getValue"),
			yhbumenId:$('#s_yhbumenId').combobox("getValue"),
	...
	function openYonghuAddDialog(){
		$("#dlg").dialog("open").dialog("setTitle","添加个人信息");
		url="../addYonghu";
	}
	...
	function daoruYonghus(){
		$("#daoru").dialog("open").dialog("setTitle","导入个人信息");
