...
<div id="login">
        ...
        <div class="main">
            <form class="formname" action="<%=basePath%>zhaohuiYonghu" name="form1" method="post">
            <ul>
            	<li>用 户 名： <input type="text" class="wa" id="yonghuName" name="yonghuName"/></li>
                <li>电话号码： <input type="text" class="wa" id="yonghuPhone" name="yonghuPhone"/></li>
