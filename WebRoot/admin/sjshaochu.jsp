...
<!--startprint-->
	<table id="dg" title="<%=newJcpeizhi.getShujuBieming()%><%=newJcpeizhi.getSjshaochuBieming()%>" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getSjshaochus?sjshaochuType2=1" fit="true" rownumbers="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="sjshaochuMark" width="40">起飞</th>
				<th field="sjshaochuMark1" width="40">到达</th>
