...
var url;
	...
	function chakanNeirong(shujuId, row) {
		return '<a style="color:red;"target="_blank" href="<%=basePath%>wangzhan/shujushow.jsp?shujuId=' + shujuId + '">查看' + '</a>';  
	}
</script>
</head>
...
<!--startprint-->
	<table id="dg" title="<%=newJcpeizhi.getShujuBieming()%>信息" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getShujus" fit="true" rownumbers="true" toolbar="#tb">
		<thead>
			<tr>
				<th field="cb" checkbox="true"></th>
				<th field="shujuId" width="10" hidden="true">编号</th>
				<th field="shujuName" width="40">名称</th>
				<th field="shujuMark" width="20">机型</th>
				<th field="shujuZong" width="10">座位</th>
				<th field="shujuDouble" width="10">售价</th>
				...
				<th field="shujuMark1" width="20">起飞</th>
				<th field="shujuMark2" width="20">到达</th>
	...
	<div id="tb">
		<div>
			...
			<a href="javascript:shangchuanShuju()" class="easyui-linkbutton" iconCls="icon-add" plain="true">上传缩略图</a>
		</div>
		<div>
		&nbsp;名称：&nbsp;<input type="text" name="s_shujuName" id="s_shujuName" size="10"/>
		&nbsp;起点：&nbsp;<input class="easyui-combobox" id="s_sjleixingId" name="s_sjleixingId"  data-options="panelHeight:'auto',editable:false,valueField:'sjleixingId',textField:'sjleixingName',url:'../sjleixingComboList'"/>
		&nbsp;终点：&nbsp;<input class="easyui-combobox" id="s_sjxingtaiId" name="s_sjxingtaiId"  data-options="panelHeight:'auto',editable:false,valueField:'sjleixingId',textField:'sjleixingName',url:'../sjleixingComboList'"/>
		...
		<form id="fm" method="post">
			<table cellspacing="5px;">
				...
				<tr>
					...
					<td>终点：</td>
					<td><input class="easyui-combobox" id="sjxingtaiId" name="sjxingtaiId"  data-options="panelHeight:'auto',editable:false,valueField:'sjleixingId',textField:'sjleixingName',url:'../sjleixingComboList'"/></td>
				</tr>
				<tr>
					<td>起飞：</td>
					<td><input readonly name="shujuMark1" id="shujuMark1" class="Wdate" type="text" onClick="WdatePicker({el:this,dateFmt:'HH:mm'})"></td>
					<td>到达：</td>
					<td><input readonly name="shujuMark2" id="shujuMark2" class="Wdate" type="text" onClick="WdatePicker({el:this,dateFmt:'HH:mm'})"></td>
				</tr>
			</table>
		</form>
	</div>
